...
const initialPending: JadwalProps[] = [
    { id: 1, nik: '100000001', nama: 'Diki M. Somantri', divisi: 'Warehouse', jam: '08:00 - 17:00 (ke 10:00 - 19:00)', tanggal: '2026-03-15' },
    { id: 2, nik: '100000002', nama: 'Asep Yuwana', divisi: 'Distribution', jam: '07:00 - 16:00 (ke 08:00 - 17:00)', tanggal: '2026-03-16' },
];
                            ...
                            {pending.map(item => (
                                <div key={item.id} className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-4 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-900/50">
                                    <div className="grid grid-cols-2 md:grid-cols-5 gap-4 flex-1">
                                        ...
                                        <div className="col-span-2 md:col-span-1">
                                            <p className="text-xs text-zinc-500 mb-1">Jam</p>
                        ...
                        <table className="w-full text-sm text-left">
                            <thead className="bg-zinc-50 dark:bg-zinc-900/50 text-zinc-500 dark:text-zinc-400 font-medium border-b border-zinc-200 dark:border-zinc-800">
                                <tr>
                                    ...
                                    <th className="px-4 py-3 whitespace-nowrap">Jam Awal</th>
                                    <th className="px-4 py-3 whitespace-nowrap">Jam Tujuan</th>
