...
const navigation: NavItem[] = [
    { name: 'Dashboard', href: '/', icon: LayoutDashboard, iconColor: 'text-zinc-900 dark:text-white' },
    {
        ...
        children: [
            { name: 'Print Koli', href: '/daily-work-print/print-koli', icon: Printer, iconColor: 'text-zinc-900 dark:text-white' },
            { name: 'Print Register', href: '/daily-work-print/print-register', icon: FileText, iconColor: 'text-zinc-900 dark:text-white' },
        ],
    },
    {
        name: 'Rekap Armada',
        ...
        iconColor: 'text-zinc-900 dark:text-white',
        children: [
            { name: 'Surat Tugas', href: '/rekap-armada/surat-tugas', icon: FileSignature, iconColor: 'text-zinc-900 dark:text-white' },
            { name: 'Surat Tugas Fresh', href: '/rekap-armada/surat-tugas-fresh', icon: Snowflake, iconColor: 'text-zinc-900 dark:text-white' },
            { name: 'Update Toko', href: '/rekap-armada/update-toko', icon: Store, iconColor: 'text-zinc-900 dark:text-white' },
            { name: 'Update Armada', href: '/rekap-armada/update-armada', icon: Wrench, iconColor: 'text-zinc-900 dark:text-white' },
            { name: 'Report', href: '/rekap-armada/report', icon: BarChart2, iconColor: 'text-zinc-900 dark:text-white' },
        ],
    },
    {
        name: 'Presensi',
        ...
        iconColor: 'text-zinc-900 dark:text-white',
        children: [
            { name: 'Report Presensi Kehadiran Karyawan', href: '/presensi/report', icon: FileText, iconColor: 'text-zinc-900 dark:text-white' },
            { name: 'Perubahan Jadwal', href: '/presensi/perubahan-jadwal', icon: CalendarDays, iconColor: 'text-zinc-900 dark:text-white' },
            { name: 'Kuota Jam Lebih', href: '/presensi/kuota-jam-lebih', icon: CalendarDays, iconColor: 'text-zinc-900 dark:text-white' },
            { name: 'Izin Keluar Jam Kerja', href: '/presensi/izin-keluar', icon: CalendarDays, iconColor: 'text-zinc-900 dark:text-white' },
            { name: 'Cuti/Izin', href: '/presensi/cuti-izin', icon: CalendarRange, iconColor: 'text-zinc-900 dark:text-white' },
        ],
    },
    {
        name: 'Labeling',
        ...
        iconColor: 'text-zinc-900 dark:text-white',
        children: [
            { name: 'Label Lokasi Permanent', href: '/label/lokasi-permanent', icon: MapPin, iconColor: 'text-zinc-900 dark:text-white' },
            { name: 'Label After Pick', href: '/label/after-pick', icon: Box, iconColor: 'text-zinc-900 dark:text-white' },
            { name: 'Label After Pick Fresh', href: '/label/after-pick-fresh', icon: Box, iconColor: 'text-zinc-900 dark:text-white' },
            { name: 'Label Preprinted', href: '/label/preprinted', icon: Hash, iconColor: 'text-zinc-900 dark:text-white' },
        ],
    },
    {
        name: 'List Karyawan',
        ...
        iconColor: 'text-zinc-900 dark:text-white',
        children: [
            { name: 'Receiving & Return', href: '/data-karyawan-receiving', icon: Users, iconColor: 'text-zinc-900 dark:text-white' },
            { name: 'Warehouse', href: '/data-karyawan-warehouse', icon: Users, iconColor: 'text-zinc-900 dark:text-white' },
            { name: 'Distribution & Delivery', href: '/data-karyawan-distribution', icon: Users, iconColor: 'text-zinc-900 dark:text-white' },
        ],
    },
];
