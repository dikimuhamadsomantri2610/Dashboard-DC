                            ...
                            <TableBody>
                                {(() => {
                                    ...
                                    if (filtered.length === 0) return (
                                        <TableRow><TableCell colSpan={7} className="text-center py-8 text-zinc-500 dark:text-zinc-400">{searchQuery ? 'Tidak ada data yang cocok.' : 'Belum ada data toko.'}</TableCell></TableRow>
                                    );
