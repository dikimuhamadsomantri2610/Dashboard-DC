                ...
                <div className="grid grid-cols-2 gap-x-12 px-2 text-[12px] mb-4">
                    <div className="space-y-1">
                        ...
                        <div className="grid grid-cols-[100px_10px_auto] border-b border-dotted border-black pb-0.5">
                            ...
                            <span>:</span>
                            <span className="font-semibold uppercase truncate">{data.nama_driver}</span>
                        </div>
                        <div className="grid grid-cols-[100px_10px_auto] border-b border-dotted border-black pb-0.5">
                            <span>NO ARMADA</span>
                            <span>:</span>
                            <span className="font-semibold uppercase truncate">{data.no_armada}</span>
                        </div>
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="grid grid-cols-[100px_10px_auto] border-b border-dotted border-black pb-0.5">
                            ...
                            <span>:</span>
                            <span className="font-semibold uppercase truncate">{data.items[0]?.number_seal || ''}</span>
                        </div>
                    ...
                    <tbody>
                        {data.items.map((item, idx) => (
                            <tr key={item.id} className="h-[30px]">
                                ...
                                <td style={{ border: '1px solid #000' }} className="px-0.5 align-middle">{item.inisial_toko}</td>
                                ...
                                <td style={{ border: '1px solid #000' }} className="px-0.5 align-middle">{item.jumlah_koli}</td>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'auto 1fr auto', alignItems: 'start', gap: '8px', marginBottom: '20px' }}>
                        ...
                        <div className="flex gap-2">
                            ...
                            <div className="flex flex-col border-2 border-black w-[110px] h-[100px]">
                                ...
                                <div className="flex-1"></div>
                                <div className="border-t-2 border-black py-0.5 text-center bg-gray-200/50">
                                    <span className="uppercase text-[9px] wrap-break-word px-1 line-clamp-1" title={data.nama_driver}>{data.nama_driver}</span>
                                </div>
                            </div>
                            {/* SECURITY */}
                            <div className="flex flex-col border-2 border-black w-[110px] h-[100px]">
