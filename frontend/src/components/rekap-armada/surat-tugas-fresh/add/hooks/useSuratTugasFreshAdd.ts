...
import { fetchSuratTugasFresh, deleteSuratTugasFresh, createSuratTugasFresh } from '../../services/surat-tugas-fresh.service';
...
export const useSuratTugasFreshAdd = () => {
    ...
    const [dc, setDc] = useState('DC FRESH');
    ...
    useEffect(() => {
        ...
        const fetchAndPopulate = async () => {
            ...
            try {
                ...
                setDc(groupItems[0].dc || 'DC FRESH');
