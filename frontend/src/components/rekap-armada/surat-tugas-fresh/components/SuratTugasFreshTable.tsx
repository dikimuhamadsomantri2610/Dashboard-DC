...
interface SuratTugasFreshTableProps {
    ...
    setGroupToConfirmPrint: (data: { group: GroupedSuratTugasFresh; index: number }) => void;
}
                            ...
                            currentData.map((group, index) => {
                                ...
                                return (
                                    <TableRow key={group.groupId}>
                                        ...
                                        <TableCell className="align-middle">{group.no_armada}</TableCell>
                                        <TableCell className="align-middle">{group.nama_driver}</TableCell>
