...
export default function PerubahanJadwalStep({
    ...
    return (
        <div className="presensi-space-y">
            <div>
                <label className="presensi-field-label">Jam Jadwal Saat Ini</label>
                <input type="time" className="presensi-input-field" value={jamAwal} onChange={e => onJamAwalChange(e.target.value)} />
            </div>
            <div>
                <label className="presensi-field-label">Jam Jadwal Tujuan</label>
                <input type="time" className="presensi-input-field" value={jamTujuan} onChange={e => onJamTujuanChange(e.target.value)} />
            </div>
            <button
