    ...
    return (
        <div className="presensi-space-y">
            ...
            <div className="presensi-two-col">
                <button className="presensi-btn-primary" onClick={() => onSubmit('istirahat_keluar')} disabled={isLoading}>
                    {isLoading ? '...' : 'Keluar Istirahat'}
                </button>
                <button className="presensi-btn-primary" onClick={() => onSubmit('istirahat_masuk')} disabled={isLoading}>
