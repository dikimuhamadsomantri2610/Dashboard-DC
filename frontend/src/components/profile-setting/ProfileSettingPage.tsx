    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-zinc-500 dark:text-zinc-400">
            Atur informasi akun pribadi Anda di sini.
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Perbarui nama tampilan dan password masuk Anda. Username tidak dapat
            diubah.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-xs text-zinc-500 mt-1">
                  Username digunakan untuk login dan tidak bisa diubah.
                </p>
              </div>
            ...
            <div className="mt-8 pt-6 border-t border-zinc-200 dark:border-zinc-800 space-y-4">
              ...
              <p className="text-sm text-zinc-500">
                Kosongkan kolom di bawah ini jika Anda tidak ingin mengubah
                password.
              </p>
